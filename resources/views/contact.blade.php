...
<footer id="footer" class="section-bg" style="margin-top: -3%;">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <div class="footer-info">
                <h3>Vishleshak</h3>
                <p>Vishleshak-Research and Development Center is a domain expert in IT solutions and services. Our core strength lies in a perfected approach to building Enterprise website development, Web and Mobile Applications, Data Analytics,Cloud Services, AI and Machine Learning and Dialer Services, Outsourced Application Management. Additionally, we address a variety of industry-specific IT-based business consulting, projects and service requirements. </p>
              </div>
              <div class="social-links">
                <a href="https://twitter.com/Vishleshak_Tech" class="twitter" target="_BLANK"><i class="fa fa-twitter"></i></a>
                <!-- <a href="#" class="facebook"><i class="fa fa-facebook"></i></a> -->
                <a href="https://www.instagram.com/vishleshak_technologies" class="instagram" target="_BLANK"><i class="fa fa-instagram"></i></a>
                <a href="https://www.linkedin.com/in/vishleshak-technologies-pvt-ltd" class="linkedin" target="_BLANK"><i class="fa fa-linkedin"></i></a>
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <div class="footer-info">
                ...
                <p>
                  ...
                  India. <br />
                  <strong>Phone:</strong> +91 9552976245<br />
