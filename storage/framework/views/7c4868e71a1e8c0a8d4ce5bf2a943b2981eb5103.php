        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="form">
              ...
              <?php endif; ?>
                <?php echo e(Form::open(array('url' => 'contact','method'=>'post','class'=>'contactForm'))); ?>
...
<?php /**PATH /var/www/html/vishleshak-website/resources/views/includes/footer.blade.php ENDPATH**/ ?>